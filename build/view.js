...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(() => {
  const data = JSON.parse(jquery__WEBPACK_IMPORTED_MODULE_0___default()(".chart-container .chart-data pre").html());
  ...
  const canvas = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".chart-container canvas");
  const chartData = {
    labels: labels,
    datasets: [{
      fill: 'origin',
